...
#oquvchilar = ["matluba","boburbek","maftuna","azizbek","murodbek","athambek"]
...
#     print(f"Xayr hurmatli {ism.upper()}")
    ...
    # raqamlar = list((1,6,-9,73))
    
    # for list in raqamlar:
    # print(f"sonining kvadrati {list*2} ga teng")
